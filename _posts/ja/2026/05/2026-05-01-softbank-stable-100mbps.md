---
layout: post
title: "【蔵出し】SoftBank 光で混雑時にも 100 Mbps の通信速度を安定して出す方法（SoftBank 回線未契約者対象）"
author: [
  "noraworld"
]
...
### 『はじめに』のまえに
⚠️ **この記事は、下書きとしてだいぶ長いこと放置されていたものを供養するために公開したものとなります。[GitHub 上では `_drafts` フォルダ内で前からアップロードされていました](https://github.com/noraworld/blog/blob/4124d1a9adba7c72f365a1c207e26c223a770f99/_drafts/softbank-guang-dehun-za-shi-nimo-100-mbps-notong-xin-su-du-woan-ding-sitechu-sufang-fa-softbank-hui-xian-wei-qi-yue-zhe-dui-xiang.markdown) が、いつまでもドラフトフォルダに放置しておきたくなかったので、ブログ公開用フォルダに移動させました。そのため、記事の情報はだいぶ古く、下書きだったため未完成で、もはや役に立たないということをあらかじめご了承ください。**

ちなみに、本当はこの記事の作成日にあわせて日付を調整して過去記事として埋もれさせようとしました（役に立たない情報のため）が、もはやいつ書いたのかもわからなくなってしまったため、もういいやということで供養した今日の日付で公開しちゃうことにしました。Git のコミット日時（2021 年 8 月 28 日）は Ghost からインポートしたときのものなので本来はもっと前だったはずです。

余談ですが、ChatGPT に生成してもらったサムネイル画像には「不安」とか「雑誌」とかよくわからない文字列が含まれていますが、これは Ghost からインポートしたときのファイル名（`softbank-guang-dehun-za-shi-nimo-100-mbps-notong-xin-su-du-woan-ding-sitechu-sufang-fa-softbank-hui-xian-wei-qi-yue-zhe-dui-xiang.markdown`）からタイトルを類推してもらったものをもとに生成しているためです。こんなことをしなくてもタイトル自体はバックアップされていたのですが、復元できるのかなんとなく気になったのと、完全には類推できなかった状態からそのまま生成させたらなんか面白い感じになってしまったのでそのまま採用したという感じです。
...
……ここでもとの下書きは終わっていました。『My SoftBank お客様専用ページにログイン』という見出しを最後に書いて力尽きたみたいです。この続きとして何を書こうとしていたかは、今となっては自分ですらわかりません。その真相は、未来永劫、闇の中に葬り去られることとなったのであった……。
