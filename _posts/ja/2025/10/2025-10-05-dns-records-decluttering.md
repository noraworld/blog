...
No. 5 〜 7 はそれぞれのサブドメインのウェブサイト用である。いずれももうこのドメインでは運営はされていないが、サブドメイン名からそれがどのようなウェブサイトであったかはおおかた予想がつくだろう。No. 5 の IP アドレスは ConoHa VPS のもので、No. 6, 7 は Amazon AWS Lightsail のものである。一番最初に借りたサーバが ConoHa VPS で、後にこのドメインとは無関係な用途でさくら VPS を借りていたこともあり、そのあと AWS に乗り移った。
